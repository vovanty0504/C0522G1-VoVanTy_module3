...
<div class="mx-5 px-5 pt-3">
    ...
    <p class="text-center">
        <a href="/employee"><i class="fa-solid fa-backward"></i> Back to Customer list</a>
    </p>
        ...
        <form class="w-50 border border-2 border-success p-3 bg-warning rounded" method="post">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" id="name" class="form-control" name="name" value="${employeeList.employeeName}">
            ...
            <div class="mt-3 form-group">
                ...
                <input type="date" id="dateOfBirth" class="form-control" name="dateOfBirth"
                       value="${employeeList.employeeDateOfBirth}">
            </div>
            ...
            <div class="mt-3 form-group">
                ...
                <div class="input-group">
                    <input type="text" id="idCard" class="form-control" name="idCard"
                           value="${employeeList.employeeIdCard}">
                    <span class="input-group-text"><i class="fa-solid fa-id-card"></i></span>
                </div>
            </div>

            <div class="mt-3 form-group">
                <label for="salary" class="h6">Id card:</label>
                <div class="input-group">
            ...
            <div class="mt-3 form-group">
                ...
                <div class="input-group">
                    <input type="text" id="phone" class="form-control" name="phone" value="${employeeList.employeePhoneNumber}">
            ...
            <div class="mt-3 form-group">
                ...
                <div class="input-group">
                    <input type="text" id="email" class="form-control" name="email" value="${employeeList.employeeEmail}">
            ...
            <div class="mt-3 form-group">
                <label class="h6" for="positionId">Customer Type:</label>
                <div class="input-group">
            ...
            <div class="mt-3 form-group">
                <label class="h6" for="educationDegreesId">Customer Type:</label>
                <div class="input-group">
            ...
            <div class="mt-3 form-group">
                <label class="h6" for="divisionId">Customer Type:</label>
                <div class="input-group">
